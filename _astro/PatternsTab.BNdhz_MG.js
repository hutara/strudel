import{j as s}from"./jsx-runtime.CLpGMVip.js";import{c as C,g as u,u as m,d as f,e as p,f as h,h as c,j as y,k as B}from"./util.DxGMlc5p.js";import{r as A}from"./index.B9mnsnPE.js";const x=`// Koji Kondo - Swimming (Super Mario World)
stack(
  seq(
    "~",
    "~",
...
.pianoroll({fold:1})`,w=`// Koji Kondo - Princess Zelda's Rescue
stack(
  // melody
...
.pianoroll({fold:1})
`,G=`// adapted from a Barry Harris excercise
"0,2,[7 6]"
  .add("<0 1 2 3 4 5 7 8>")
  .scale('C bebop major')
  .transpose("<0 1 2 1>/8")
...
//.pianoroll({fold:1})`,S=`// "Wavy kalimba"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
.clip(.5)
.piano()
.pianoroll()`,T=`// Hirokazu Tanaka - World 1-1
stack(
  // melody
  note(\`<
...
note(
  ...
  .gain(.5)
  .room(.5)
  .lpa(.125).lpenv(-2).v("8:.125").fanchor(.25)`,q=`// "Festival of fingers 3"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
n("[-7*3],0,2,6,[8 7]")
  ...
  .slow(2).piano()
//.pianoroll({maxMidi:160})`,M=`// "Melting submarine"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
stack(
    ...
    .delayfeedback(.7)
    .orbit(2)
  ).sometimes(x=>x.speed("-1"))`,W=`// "Belldub"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
).reset("<x@7 x(5,8,-1)>")`,V=`// "Jux und tollerei"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
.note()
//.pianoroll()
.csound('CoolSynth')`,Q=`// "Lounge sponge"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
...
`,ee=Object.freeze(Object.defineProperty({__proto__:null,amensister:$,arpoon:X,barryHarris:G,bassFuge:O,belldub:W,blippyRhodes:E,caverave:D,chop:K,csoundDemo:Z,delay:H,dinofunk:U,echoPiano:N,festivalOfFingers:j,festivalOfFingers3:q,flatrave:I,giantSteps:v,goodTimes:R,holyflute:J,juxUndTollerei:V,loungeSponge:Q,meltingsubmarine:M,orbit:L,randomBells:P,sampleDemo:z,sampleDrums:k,sml1:T,swimming:x,undergroundPlumber:_,waa2:Y,wavyKalimba:S,zeldasRescue:w},Symbol.toStringTag,{value:"Module"}));Object.fromEntries(Object.entries(ee).map(([e,o],a)=>[a,{id:a,code:o,collection:"Stock Examples"}]));function F(...e){return e.filter(Boolean).join(" ")}function i({children:e,label:o,labelIsHidden:a,className:t,...l}){return s.jsxs("button",{className:F("hover:opacity-50 text-nowrap w-fit",t),title:o,...l,children:[a!==!0&&o,e]})}function se({pattern:e}){const o=A.useMemo(()=>u(e.code),[e]);let a=o.title;if(a==null){const l=new Date(e.created_at);isNaN(l)?a="unnamed":a=l.toLocaleDateString()}const t=Array.isArray(o.by)?o.by.join(","):"Anonymous";return s.jsx(s.Fragment,{children:`${e.id}: ${a} by ${t.slice(0,100)}`.slice(0,60)})}function ae({showOutline:e,onClick:o,pattern:a,showHiglight:t}){return s.jsx("a",{className:F("mr-4 hover:opacity-50 cursor-pointer block",e&&"outline outline-1",t&&"bg-selection"),onClick:o,children:s.jsx(se,{pattern:a})})}function oe({patterns:e,activePattern:o,onClick:a,started:t}){const l=p(),d=h(l).id;return s.jsx("div",{className:"",children:Object.values(e).reverse().map(n=>{const b=n.id;return s.jsx(ae,{pattern:n,showHiglight:b===d,showOutline:b===o&&t,onClick:()=>a(b)},b)})})}const r=(e,o,a=!1)=>{e.handleUpdate(o,a)},ne=!C();function te({context:e}){const o=f(),a=p(),t=h(a),{userPatterns:l,patternFilter:g}=m(),d=t?.id;return s.jsxs("div",{className:"flex flex-col gap-2 flex-grow overflow-hidden h-full pb-2 ",children:[s.jsxs("div",{className:"pr-4 space-x-4  flex max-w-full overflow-x-auto",children:[s.jsx(i,{label:"new",onClick:()=>{const{data:n}=c.createAndAddToDB();r(e,n)}}),s.jsx(i,{label:"duplicate",onClick:()=>{const{data:n}=c.duplicate(t);r(e,n)}}),s.jsx(i,{label:"delete",onClick:()=>{const{data:n}=c.delete(d);r(e,{...n,collection:c.collection})}}),s.jsxs("label",{className:"hover:opacity-50 cursor-pointer",children:[s.jsx("input",{style:{display:"none"},type:"file",multiple:!0,accept:"text/plain,text/x-markdown,application/json",onChange:n=>y(n.target.files)}),"import"]}),s.jsx(i,{label:"export",onClick:B}),s.jsx(i,{label:"delete-all",onClick:()=>{const{data:n}=c.clearAll();r(e,n)}})]}),s.jsx("div",{className:"overflow-auto h-full bg-background p-2 rounded-md",children:s.jsx(oe,{onClick:n=>r(e,{...l[n],collection:c.collection},ne),patterns:l,started:e.started,activePattern:o,viewingPatternID:d})})]})}function re({context:e}){return m(),s.jsx("div",{className:"px-4 w-full text-foreground  space-y-2  flex flex-col overflow-hidden max-h-full h-full",children:s.jsx(te,{context:e})})}export{i as A,se as P,re as a,F as c};
